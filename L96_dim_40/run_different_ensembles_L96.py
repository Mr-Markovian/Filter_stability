...
parameters['forcing_x']  =8          # forcing
...
os.chdir(r'/home/shashank/Lorenz_63/40_dim_L96')
str1_=os.getcwd()
...
for w in range(10):
    ...
    #bias in mean.This choice is implemented through the initial ensemble.
        ...
        Ens=np.load(str_2+'/Ensemble={}_bias_{}_init_cov_{}_seed_{}.npy'.format(400,i,j,45))
