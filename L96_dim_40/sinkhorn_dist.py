...
str_='/home/shashank/Lorenz_63/40_dim_L96'
os.chdir(str_)
...
file_label1='bias={}_obs={}_ens={}_Mcov={},ocov={}_,gap={}_alpha=1.0_loc=gaspri_r={}'.format(bias1,ob_dim,N,ens_cov1,mu,ob_gap,l_scale)
file_label2='bias={}_obs={}_ens={}_Mcov={},ocov={}_,gap={}_alpha=1.0_loc=gaspri_r={}'.format(bias2,ob_dim,N,ens_cov2,mu,ob_gap,l_scale)
...
os.chdir(str_+'/codes')
np.save('a_distance_between_bias,cov={}_{}and{}_{}_for_mu={},ob_gap={}_for_N={}_1to10_t=0to100'.format(bias1,ens_cov1,bias2,ens_cov2,mu,ob_gap,N),distance)
